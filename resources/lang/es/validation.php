...
return [
    ...
    | ayuda a mantener las traducciones específicas para un atributo en particular.
    |
    */
    ...
    | de atributos por algo más amigable para el lector, como "Dirección de correo
    | electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer que
    | los mensajes sean más expresivos.
    |
    */
