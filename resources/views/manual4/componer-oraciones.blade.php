...
<div class="container">
    ...
    <!-- Título -->
    <h1 class="text-primary fw-bold">COMPONER ORACIONES</h1>

    <!-- Descripción -->
    <p class="text-muted fs-4">Este manual corresponde a la etapa 4 de la plataforma de estudiantes.</p>
