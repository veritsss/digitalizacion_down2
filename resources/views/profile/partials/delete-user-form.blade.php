<section class="space-y-6">
    ...
    <!-- Modal de confirmación para la eliminación de cuenta -->
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 space-y-6">
            ...
            <!-- Botones de acción -->
            <div class="mt-6 flex justify-between sm:justify-end gap-4">
                <x-secondary-button x-on:click.prevent="$dispatch('close')" class="w-full sm:w-auto">
                    {{ __('Cancelar') }}
                </x-secondary-button>
