...
<div class="container">
    ...
    <h1 class="text-primary fw-bold">Reconocimiento de Sílabas</h1>
    <p class="text-muted fs-5">Este manual corresponde a la etapa 3 de la plataforma de estudiantes.</p>

    <p class="lead">Aquí aprenderás sobre el reconocimiento de sílabas, una habilidad clave para la lectura y escritura.</p>
</div>
@endsection
