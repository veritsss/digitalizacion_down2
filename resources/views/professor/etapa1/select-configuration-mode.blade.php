            ...
            <div class="col-md-5 mb-4 d-flex">
                <div class="card shadow-sm border-primary equal-height-card w-100">
                    <div class="card-body text-center d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('professor.selectQuestionImagesPageE1', ['folder' => $folder, 'mode' => 'images']) }}" class="btn btn-primary btn-lg w-100 mt-auto">
            ...
            <div class="col-md-5 mb-4 d-flex">
                <div class="card shadow-sm border-success equal-height-card w-100">
                    <div class="card-body text-center d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('professor.selectQuestionImagesPageE1', ['folder' => $folder, 'mode' => 'pairs']) }}" class="btn btn-success btn-lg w-100 mt-auto">
                                Seleccionar Pares
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-5 mb-4 d-flex">
                <div class="card shadow-sm border-primary equal-height-card w-100">
                    <div class="card-body text-center d-flex flex-column">
                        ...
                        <p class="card-text text-muted flex-grow-1">Selecciona las imágenes para luego configurar las respuestas correctas.</p>
                        <div class="mt-auto">
                            <a href="{{ route('professor.selectQuestionImagesPageE1', ['folder' => $folder, 'mode' => 'seriesTemporales']) }}" class="btn btn-primary btn-lg w-100 mt-auto">
                                Agrupar imágenes
                            </a>
                        </div>
                    </div>
