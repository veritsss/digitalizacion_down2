...
<form id="correct-images-form" action="{{ route('professor.saveCorrectImagesE1', ['folder' => $folder]) }}" method="POST">
        @csrf
    ...
    <a href="{{ route('professor.selectConfigurationModeE1', ['folder' => $folder]) }}" class="btn btn-primary btn-lg w-50 py-3" id="next-button">
        Siguiente
    </a>
</div>
...
<script>
    ...
    document.getElementById('save-button').addEventListener('click', function () {
        ...
        fetch("{{ route('professor.saveCorrectImagesE1',['folder' => $folder]) }}", {
            method: "POST",
            headers: {
