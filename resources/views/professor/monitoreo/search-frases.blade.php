@extends('layouts.app')
@section('title', 'Buscar Estudiantes - Frases')
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-primary fw-bold mb-0">Buscar Estudiantes - Frases</h1>
    </div>
            ...
            <ul class="list-group shadow-sm">
                @foreach($students as $student)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('professor.showPhrases', $student->id) }}" class="btn btn-sm btn-primary">
                            <i class="fas fa-book"></i> Frases
                        </a>
                    </li>
                @endforeach
            </ul>
            ...
            if (data.length > 0) {
                ...
                data.forEach(student => {
                    ...
                    li.innerHTML = `
                        ...
                        <a href="/professor/student/${student.id}/frases" class="btn btn-sm btn-primary">Frases</a>
                    `;
                    ul.appendChild(li);
                });
