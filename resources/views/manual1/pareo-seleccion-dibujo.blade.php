...
<div class="container">
    ...
    <p class="text-muted fs-4">Este manual corresponde a la etapa 1 de la plataforma de estudiantes.</p>
    ...
    @if($isProfessor)
        ...
        @endif
        <a href="{{ route('professor.selectQuestionImages') }}" class="btn btn-primary btn-lg d-block text-center mt-3">
