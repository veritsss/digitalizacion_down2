...
<div class="container">
    ...
    <!-- Título y contenido con mejor diseño -->
    ...
    <p class="lead">En esta etapa, se trabajará con tarjetas e imágenes para fortalecer la asociación visual y mejorar el aprendizaje.</p>
</div>
@endsection
